...
void newgame()
{
		...
		if(!P1.hbm){P1.hbm      = LoadBitmap(g_hInst, "RAUMSCHIFF1");}
         ...
         if(!P2.hbm){P2.hbm      = LoadBitmap(g_hInst, "RAUMSCHIFF2");}
...
{
     if(GetAsyncKeyState(0x53) && P1.Y + P1.bmp.bmHeight < 700)
     {
                               P1.Y += P1.delta;
     }
     ...
     if(GetAsyncKeyState(0x44) && P1.X + P1.bmp.bmWidth < 1000)
     {
                               P1.X += P1.delta;
     }
     ...
     if(GetAsyncKeyState(VK_DOWN) && P2.Y + P2.bmp.bmHeight < 700)
     {
                               P2.Y += P2.delta;
     }
     ...
     if(GetAsyncKeyState(VK_RIGHT) && P2.X + P2.bmp.bmWidth < 1000)
     {
                               P2.X += P2.delta;
     }
