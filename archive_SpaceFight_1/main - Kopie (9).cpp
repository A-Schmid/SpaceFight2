...
{
     if(GetAsyncKeyState(0x53) && P1.Y + P1.bmp.bmHeight < 700 && P1.Y > -10)
     {
                               P1.Y += P1.delta;
     }
     if(GetAsyncKeyState(0x57) && P1.Y + P1.bmp.bmHeight < 710 && P1.Y > 0)
     {
                               P1.Y -= P1.delta;
     }
     if(GetAsyncKeyState(0x44) && P1.X > -10 && P1.X + P1.bmp.bmWidth < 1000)
     {
                               P1.X += P1.delta;
     }
     if(GetAsyncKeyState(0x41) && P1.X > 0 && P1.X + P1.bmp.bmWidth < 1010)
     {
                               P1.X -= P1.delta;
     }
     ...
     if(GetAsyncKeyState(VK_DOWN) && P2.Y > -10 && P2.Y + P2.bmp.bmHeight < 700)
     {
                               P2.Y += P2.delta;
     }
     if(GetAsyncKeyState(VK_UP) && P2.Y > 0 && P2.Y + P2.bmp.bmHeight < 710)
     {
                               P2.Y -= P2.delta;
     }
     if(GetAsyncKeyState(VK_RIGHT) && P2.X > -10 && P2.X + P2.bmp.bmWidth < 1000)
     {
                               P2.X += P2.delta;
     }
     if(GetAsyncKeyState(VK_LEFT) && P2.X > 0 && P2.X + P2.bmp.bmWidth < 1010)
     {
                               P2.X -= P2.delta;
     }
